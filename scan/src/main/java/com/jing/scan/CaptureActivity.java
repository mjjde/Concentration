...
import com.jing.scan.camera.CameraManager;
import com.jing.scan.common.BitmapUtils;
import com.jing.scan.decode.BitmapDecoder;
import com.jing.scan.decode.CaptureActivityHandler;
import com.jing.scan.view.ViewfinderView;
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case PARSE_BARCODE_SUC: // 解析图片成功
					...
					intent.putExtra(SCAN_RESULT, msg.obj.toString());
...
//				Toast.LENGTH_SHORT).show();
		Intent intent = new Intent();
		intent.putExtra(SCAN_RESULT, ResultParser.parseResult(rawResult).toString());
		setResult(RESULT_OK, intent);
		finish();
	}
